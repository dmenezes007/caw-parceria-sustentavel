  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="space-y-2">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Mitigação de Riscos & Compliance</h2>
        <p className="text-sm md:text-base text-slate-500 max-w-2xl">Segurança jurídica inabalável através de modelos formais e transparentes.</p>
      </header>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        <div className="md:col-span-2 p-6 md:p-8 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between">
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 rounded-2xl bg-orange-50 flex items-center justify-center text-orange-600">
                <Scale size={24} />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-slate-800">Alinhamento com a Lei 13.467/2017</h3>
            </div>
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-slate-50 border border-slate-200 flex flex-col items-center text-center justify-center space-y-4">
