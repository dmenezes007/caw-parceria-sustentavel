  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="space-y-2">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Impacto Financeiro & Memória</h2>
        <p className="text-sm md:text-base text-slate-500 max-w-2xl">A estabilidade da equipe não é apenas um valor humano, é uma decisão financeira estratégica que preserva o capital intelectual.</p>
      </header>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
        <div className="p-6 md:p-8 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
          ...
          <h4 className="text-sm md:text-base font-bold text-slate-800">Custo do Turnover</h4>
          <p className="text-2xl md:text-3xl font-black text-rose-600">50-200%</p>
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
          ...
          <h4 className="text-sm md:text-base font-bold text-slate-800">Memória Institucional</h4>
          <p className="text-2xl md:text-3xl font-black text-indigo-600">Zero Loss</p>
          <p className="text-sm text-slate-500 leading-relaxed">
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
          ...
          <h4 className="text-sm md:text-base font-bold text-slate-800">Eficiência Onboarding</h4>
          <p className="text-2xl md:text-3xl font-black text-emerald-600">-70%</p>
          <p className="text-sm text-slate-500 leading-relaxed">
      ...
      <div className="p-6 md:p-10 rounded-[2.5rem] bg-slate-900 text-white overflow-hidden relative">
        <div className="relative z-10 grid md:grid-cols-2 gap-6 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6">
            <h3 className="text-xl md:text-2xl font-bold">Por que o turnover é o "vazamento silencioso"?</h3>
