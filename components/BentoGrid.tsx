...
export const BentoGrid: React.FC = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(180px,_auto)]">
      ...
      <div className="md:col-span-8 p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow group">
        <div className="flex flex-col md:flex-row gap-8 h-full">
          <div className="flex-1 space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-rose-50 flex items-center justify-center text-rose-600">
              <TrendingDown size={28} />
            </div>
            <h3 className="text-2xl font-bold text-slate-800">Corte o Custo Oculto do Turnover</h3>
      ...
      <div className="md:col-span-4 p-8 rounded-3xl bg-indigo-50 border border-indigo-100 flex flex-col justify-between group">
        <div className="space-y-4">
          <Heart className="text-indigo-600" size={32} />
          <h3 className="text-xl font-bold text-indigo-900">Produtividade Humana</h3>
      ...
      <div className="md:col-span-4 p-8 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between">
        <div className="space-y-4">
          <ShieldAlert className="text-orange-500" size={32} />
          <h3 className="text-xl font-bold text-slate-800">Segurança Jurídica</h3>
          <p className="text-sm text-slate-600 leading-relaxed">
            Mitigue riscos trabalhistas com modelos formais alinhados à <b>Lei 13.467/2017</b>. Compliance não é opcional, é reputação.
          </p>
        </div>
      ...
      <div className="md:col-span-8 p-8 rounded-3xl bg-white border border-slate-200 shadow-sm">
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-2xl font-bold text-slate-800">Contrastes que Fazem a Diferença</h3>
      ...
      <div className="md:col-span-12 p-10 rounded-3xl bg-slate-900 text-white flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
          <button className="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 rounded-2xl font-bold transition-all shadow-xl shadow-indigo-500/20">
            Agende uma conversa
          </button>
